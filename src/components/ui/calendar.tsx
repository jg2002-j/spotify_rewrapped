    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day: cn(buttonVariants({ variant: "noShadow" }), "h-9 w-9 p-0 font-base aria-selected:opacity-100"),
                day_range_end: "day-range-end",
                day_selected: "!bg-black text-white rounded-base",
                day_today: "bg-white text-text dark:bg-secondaryBlack dark:text-darkText",
